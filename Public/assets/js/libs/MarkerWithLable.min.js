    ...
    this.getPanes().overlayImage.appendChild(this.labelDiv_),
      ...
      (this.listeners_ = [
        ...
        google.maps.event.addDomListener(
          ...
          function (d) {
            (c = !1),
              a.marker_.getDraggable() && ((b = !0), (this.style.cursor = l)),
              (a.marker_.getDraggable() || a.marker_.getClickable()) &&
                (google.maps.event.trigger(a.marker_, "mousedown", d), m(d));
          }
        ),
        google.maps.event.addDomListener(document, "mouseup", function (e) {
          ...
          if (
            ...
            if (h) {
              (f = a
                .getProjection()
                .fromLatLngToDivPixel(a.marker_.getPosition())),
                (f.y += k),
                a.marker_.setPosition(
                  a.getProjection().fromDivPixelToLatLng(f)
                );
              try {
        ...
        google.maps.event.addListener(
          ...
          function (g) {
            ...
            b &&
              (c
                ? ((g.latLng = new google.maps.LatLng(
                    g.latLng.lat() - e,
                    g.latLng.lng() - f
                  )),
                  ...
                  h &&
                    ...
                    (l.y -= k)),
                  a.marker_.setPosition(
                    a.getProjection().fromDivPixelToLatLng(l)
                  ),
                  h && (a.eventDiv_.style.top = l.y + k + "px"),
        ...
        google.maps.event.addDomListener(this.eventDiv_, "click", function (b) {
          (a.marker_.getDraggable() || a.marker_.getClickable()) &&
            (g
              ? (g = !1)
              : (google.maps.event.trigger(a.marker_, "click", b), m(b)));
        }),
        google.maps.event.addDomListener(
          this.eventDiv_,
          "dblclick",
