  ...
  $("#autocompletetransfer1")
    .catcomplete({
      ...
      source: function (request, response) {
        ...
        // }
        $.getJSON(
          myconfig.site_url + "autocomplete/get_transferPickup",
          request,
  ...
  $("#autocompletetransfer2")
    .catcomplete({
      ...
      source: function (request, response) {
        ...
        $.getJSON(
          myconfig.site_url +
            "autocomplete/get_transferDropOff/" +
            pickupCode +
            "/" +
            category,
          request,
...
function submit_flight_details(id) {
  ...
  $("#passenger_address").html(
    $("#addressLine1").val() + " " + $("#addressLine2").val()
  );
  $("#passenger_phone").html(
    $("#countryCode").val() + " " + $("#tpnumber").val()
  );
